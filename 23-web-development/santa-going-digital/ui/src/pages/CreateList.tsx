...
import { PostData } from "../hooks/postUtility";
      ...
      <form onSubmit={handleSubmit}>
        <ul>
          ...
          <li>
            ...
            <textarea id="message" name="message_for_santa" defaultValue="Write your message here">
            </textarea>
          </li>

          <li>
            <label htmlFor="items">Your Items: </label>
            <textarea id="items" name="item_names" defaultValue="Input your items">
